...
struct encoder *setupencoder(int pin_a, int pin_b, int defaultValue)
{
    ...
    newencoder->value = defaultValue;
    newencoder->lastEncoded = defaultValue;
...
void setValue(struct encoder* p, long val)
{
	if (p != NULL)
		p->value = val;
}
