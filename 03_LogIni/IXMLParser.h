...
class XMLDLLENTRY IXMLReaderFile: public IXMLReader {
public:
...
class XMLDLLENTRY IXMLReaderStringSZ: public IXMLReader {
public:
...
public:
    ...
    virtual void clear()=0; ///< free all internal memory buffers
    ...
    static IXMLStr charEncodingText(IXMLCharEncoding e); ///< return the text-version of the given char encoding
 ...
 *   </ul>
 */
class XMLDLLENTRY IXMLPullParser : public IPullParser 
{
public:
...
class XMLDLLENTRY IJSONPullParser: public IPullParser
{
public:
...
class XMLDLLENTRY IXMLDomParser
{
public:
     ...
     */
    int  getDomMaxMemorySize(); ///< Returns the DomMaxMemorySize parameter (zero means "no limit")
...
public:
    ...
    ITCXMLNode(const ITCXMLNode &A);                                     ///< to allow shallow/fast copy:
 ...
 * </ul> 
 */
 class XMLDLLENTRY ICXMLNode: public ITCXMLNode
{
friend class IXMLRenderer;
public:
 ...
 * </ul> 
 */
class XMLDLLENTRY IXMLNode: public ITCXMLNode
{
friend class IXMLRenderer;
...
class XMLDLLENTRY ToIXMLStringTool
{
public:
...
class XMLDLLENTRY IXMLRenderer
{
public:
    IXMLRenderer();
    ~IXMLRenderer();
...
XMLDLLENTRY void freeIXMLString(IXMLStr t); // {free(t);}
/** @} */
 ...
 * @{ */
// XMLDLLENTRY char      xmltob(IXMLCStr s,char defautValue=0);
// XMLDLLENTRY int       xmltoi(IXMLCStr s,int defautValue=0);
// XMLDLLENTRY long long xmltol(IXMLCStr s,long long defautValue=0);
// XMLDLLENTRY double    xmltof(IXMLCStr s,double defautValue=.0);
// XMLDLLENTRY IXMLCStr  xmltoa(IXMLCStr s,IXMLCStr defautValue=_CXML(""));
// XMLDLLENTRY IXMLChar  xmltoc(IXMLCStr s,const IXMLChar defautValue=_CXML('\0'));
/** @} */
 ...
 */
class XMLDLLENTRY IXMLParserBase64Tool
{
public:
