...
namespace Lumitech.Helpers
{
   ...
   /* public struct cmCIECMF
    ...
    public static class Photometric
    {
        ...
        public static Dictionary<int, CIECoords> PlanckLine = new Dictionary<int, CIECoords>();
       ...
       public static double getMacAdamRadius(MacAdams mca, CIECoords cxy)
       {
        ...
        private static void InitPlanckLine()
        {
            for (int i = 2000; i<=10000; i+=100)
            {
                PlanckLine.Add(i, CCT2xy(i, Observer.Observer10deg));
            }
        }
