...
namespace Lumitech.Interfaces
{
    ...
    {        
        ...
        private const string sqlInsert = "insert into LLData(roomID, userID, VLID, SceneID, SequenceID, Brightness, CCT, x, y, pimode, sender, receiver, MsgTypeID, Remark, IP, groupiD)" +
